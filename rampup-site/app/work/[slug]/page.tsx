  ...
  return (
    <>
      ...
      <main className="min-h-[100dvh] bg-[#EDEDED]">
        ...
        {/* ── Platforms ── */}
        <section className="max-w-5xl mx-auto px-5 md:px-12 mb-14 text-center">
          <h2 className="font-sora font-bold text-2xl md:text-3xl text-dark mt-10 mb-8">
          ...
          <div className="flex justify-center gap-6 md:gap-10 flex-wrap">
            {[
              ...
              <div
                key={label}
                className="flex flex-col items-center gap-1 text-[#2D2D2D] hover:opacity-70 transition-opacity"
              >
                {icon}
                <span className="font-poppins text-sm text-[#555555]">{label}</span>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="bg-dark rounded-card p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="font-sora font-extrabold text-2xl md:text-3xl text-white tracking-tight mb-2">
                Ready to transform your socials like {client.name}?
              </h2>
