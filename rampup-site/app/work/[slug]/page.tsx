        ...
        <section className="max-w-5xl mx-auto px-5 md:px-12 mb-14">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-[0_1px_4px_rgba(0,0,0,0.07)]"
              >
                <span className="text-[#2D2D2D]">{icon}</span>
                <span className="font-poppins text-[13px] font-medium text-[#2D2D2D]">{label}</span>
              </div>
            ))}
          </div>
        </section>
