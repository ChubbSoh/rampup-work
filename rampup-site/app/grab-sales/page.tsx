      ...
      <main className="min-h-[100dvh] bg-[#EDEDED]">
        ...
        <section className="py-20 md:py-24">
          <div className="max-w-site mx-auto px-5 md:px-12">
            ...
            >
              {[
                { before: '฿665K', after: '฿1.25M', timeframe: '2 months', growth: '+81.6%', monthly: '+฿295K / month', beforeImg: '/results/proof-1-after.jpg', afterImg: '/results/proof-1-before.jpg' },
                { before: '฿300K', after: '฿628K',  timeframe: '1 month',  growth: '+130.7%', monthly: '+฿328K / month', beforeImg: '/results/proof-2-before.jpg', afterImg: '/results/proof-2-after.jpg' },
                { before: '฿127K', after: '฿249K',  timeframe: '1 month',  growth: '+120.6%', monthly: '+฿122K / month', beforeImg: '/results/proof-3-before.jpg', afterImg: '/results/proof-3-after.jpg' },
                { before: '฿431K', after: '฿814K',  timeframe: '1 month',  growth: '+193.1%', monthly: '+฿383K / month', beforeImg: '/results/proof-4-before.jpg', afterImg: '/results/proof-4-after.jpg' },
              ].map((card) => (
                <div
                  key={card.before}
