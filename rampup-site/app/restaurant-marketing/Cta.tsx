...
export function CtaLink({
  ...
  const base =
    'inline-flex items-center justify-center font-poppins font-bold text-[15px] px-8 py-4 rounded-pill transition-all active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green focus-visible:ring-offset-2'
  const styles = {
    solid: 'bg-green text-white hover:brightness-105',
    outline: 'bg-transparent text-dark border border-black/15 hover:border-black/35',
  ...
  return (
    ...
    >
      <a
        ...
        className="flex items-center justify-center w-full bg-green text-white font-poppins font-bold text-[15px] py-3.5 rounded-pill active:scale-[0.99] transition"
      >
